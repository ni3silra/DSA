...
public class AllUniquePermutations {
	...
	public static void main(String[] args) {
		System.out.println(new AllUniquePermutations().permute(new ArrayList<>(List.of(1, 1, 2))));
	}
	...
	public ArrayList<ArrayList<Integer>> permute(ArrayList<Integer> A) {
		...
		HashSet<ArrayList<Integer>> map = calculatePermutations(nums, new ArrayList<>(),
	...
	public HashSet<ArrayList<Integer>> calculatePermutations(int[] nums, ArrayList<Integer> asf,
			HashSet<ArrayList<Integer>> finalRes) {
